...
let arrImg = [
  `<img  src="img/1.png" class="img-slider zind" alt=""/>`,
  `<img  src="img/2.png" class="img-slider" alt="" />`,
  `<img  src="img/3.png" class="img-slider" alt="" />`,
  `<img  src="img/4.png" class="img-slider" alt="" />`,
  `<img  src="img/5.png" class="img-slider" alt="" />`,
];
...
myNumber.forEach((item, index) => {
  item.addEventListener("click", (eo) => {
    ...
    sliderContiner.innerHTML += `
    <p style="z-index: 10" class="active-num">slide # ${index + 1} of ${
      arrImg.length
    }</p>`;
